...
RegisterNetEvent('nightclubs:client:entranceMenu', function(args)
    lib.registerContext({
        ...
        options = {
            {
                title = 'Buy, Enter, or Visit a Club',
            },
            {
                title = 'Buy',
            ...
            },
            {
                ...
                description = 'Enter your nightclub',
                icon = 'arrow-right',
            ...
            {
                title = 'Visit',
                description = 'Visit a friend\'s club',
                icon = 'handshake',
                disavbled = false,
                onSelect = function()
...
RegisterNetEvent('nightclubs:client:bossMenu', function(ClubData, Employee)
        ...
        options = {
            ...
            },
            {
                ...
                onSelect = function()
                    if ClubData.Metadata['speakers'] ~= tostring(nil) and ClubData.Metadata['turntables'] ~= tostring(nil) then
                        ...
                        -- exports['okokNotify']:Alert('Nightclub', 'You hired a DJ!', 7000, 'success', true)
                        lib.notify({ title = 'Nightclub', description = 'You hired a DJ!', type = 'success', duration = 7000 })
                    else
                        -- exports['okokNotify']:Alert('Nightclub', 'How can the DJ work without turntables or speakers?', 7000, 'warning', true)
                        lib.notify({ title = 'Nightclub', description = 'How can the DJ work without turntables or speakers?', type = 'warning', duration = 7000 })
                    end
            ...
            },
            {
                ...
                onSelect = function()
                    ...
                    -- exports['okokNotify']:Alert('Nightclub', 'You fired your DJ!', 7000, 'success', true)
                    lib.notify({ title = 'Nightclub', description = 'You fired your DJ!', type = 'warning', duration = 7000 })
                end,
    ...
    lib.registerContext({
        ...
        options = {
            ...
            {
                title = 'Hire',
                description = 'Hire a dancer (Requires podiums)',
                icon = 'check',
                onSelect = function()
                    if ClubData.Metadata['podium'] ~= tostring(nil) then
                        TriggerServerEvent('nightclubs:server:employeesFunction', 'dancers', true)
                        -- exports['okokNotify']:Alert('Nightclub', 'You hired a dancer!', 7000, 'success', true)
                        lib.notify({ title = 'Nightclub', description = 'You hired a dancer!', type = 'success', duration = 7000 })
                    else
                        -- exports['okokNotify']:Alert('Nightclub', 'How can the Dancer dance without podiums?', 7000, 'warning', true)
                        lib.notify({ title = 'Nightclub', description = 'How can the dancer dance without podiums?', type = 'warning', duration = 7000 })
                    end
            ...
            },
            {
                ...
                onSelect = function()
                    ...
                    -- exports['okokNotify']:Alert('Nightclub', 'You fired a dancer!', 7000, 'success', true)
                    lib.notify({ title = 'Nightclub', description = 'You fired a dancer!', type = 'success', duration = 7000 })
                end,
    ...
    lib.registerContext({
        ...
        options = {
            ...
            {
                title = 'Hire',
                description = 'Hire a bartender',
                icon = 'check',
                onSelect = function()
                    TriggerServerEvent('nightclubs:server:employeesFunction', 'tenders', true)
                    -- exports['okokNotify']:Alert('Nightclub', 'You hired a bartender!', 7000, 'success', true)
                    lib.notify({ title = 'Nightclub', description = 'You hired a bartender!', type = 'success', duration = 7000 })
                end,
                disabled = checkDisabled(Employee, 'tenders', Config.Employee.tenders.locations, false)
            },
            {
                title = 'Fire',
                description = 'Fire a bartender',
                icon = 'circle-xmark',
                onSelect = function()
                    TriggerServerEvent('nightclubs:server:employeesFunction', 'tenders', false)
                    -- exports['okokNotify']:Alert('Nightclub', 'You fired a bartender!', 7000, 'success', true)
                    lib.notify({ title = 'Nightclub', description = 'You fired a bartender!', type = 'success', duration = 7000 })
                end,
